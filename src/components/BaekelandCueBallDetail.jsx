      ...
      <div style={{
        ...
        <div style={{
          ...
          <div className="product-detail-grid">
            {/* Product Image */}
            <img 
              src="/images/Cueball.png" 
              alt="Baekeland Cue Ball"
              style={{
                width: '100%',
                height: 'auto',
                objectFit: 'contain'
            ...
            <div>
              ...
              <p style={{
                ...
                TV Pool Ball – Designed for Precision and Endurance
              </p>
              ...
              <div style={{
                ...
                <p style={{
                  ...
                  Crafted from high-purity phenolic resin, the Baekeland Cue Ball delivers unmatched 
                  control, durability, and responsiveness — engineered for professional Pool tournaments.
                </p>
              </div>
          ...
          <div style={{
            ...
            <div style={{
              ...
              {[
                { label: 'Size', value: '57.2 mm' },
                { label: 'Weight', value: '169 g ± 1 g' },
                { label: 'Density', value: '1.73' },
                { label: 'Roundness', value: '< 0.03 mm' },
                { label: 'Hardness', value: '> 40 Rockwell' },
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ width: '40px', height: '1px', background: '#0ea5e9', opacity: 0.6 }} />
              <div style={{ 
                width: '8px', 
                height: '8px', 
                background: '#0ea5e9', 
              ...
              <div style={{
                ...
                <a 
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.target.style.borderBottomColor = '#0284c7';
                    e.target.style.transform = 'translateY(-1px)';
                  }}
                  onMouseLeave={(e) => {
                    e.target.style.color = '#0ea5e9';
                    e.target.style.borderBottomColor = '#0ea5e9';
