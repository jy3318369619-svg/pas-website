        ...
        <div style={{
            ...
            <div>
              ...
              <div style={{
                ...
                <p style={{
                  ...
                  Showcased in numerous major professional tournaments and highly acclaimed by professional players. Crafted using a twill weave technique, it rivals the world's top-tier cloths, ensuring smoother and more stable ball movement.
                </p>
              </div>
          ...
          <div style={{
            ...
            <div className="specs-grid">
              {[
                { label: 'Weight', value: 'Snooker: 950g/m (33.6 oz/m)\nChinese pool/Heyball: 780g/m (27.5 oz/m)' },
