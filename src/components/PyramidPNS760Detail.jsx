...
const PyramidPNS760Detail = () => {
  const navigate = useNavigate();
  const [selectedColor, setSelectedColor] = useState(0);

  const colors = [
    { name: 'Yellow Green', value: '#4A8B6F', image: '/images/pns-760-pyramid.png' }
  ];
  ...
  const keyFeatures = [
    'Advanced Model Pyramid cloth',
    'Fast and consistent ball roll',
    'Improved accuracy and ball response',
    'Smooth and refined playing surface',
    'High durability for intensive club use',
    'Suitable for advanced players and competitive clubs'
  ];
    ...
    <div className="product-detail-page" style={{ minHeight: '100vh', background: '#ffffff', padding: '104px 0 64px 0' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 40px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '80px', alignItems: 'center' }}>
          <img src={colors[selectedColor].image} alt="Pyramid PNS 760" style={{ width: '100%', height: 'auto', objectFit: 'contain' }} />
          ...
          <div>
            ...
            <p style={{ fontSize: '1.1rem', color: '#1d1d1f', lineHeight: 1.6, marginBottom: '32px' }}>
              PNS 760 is an Advanced Model Pyramid billiard cloth developed for players and clubs requiring faster, more consistent and more responsive play. The higher wool content combined with nylon reinforcement creates a refined playing surface with improved ball roll, speed consistency and durability.
              <br /><br />
              It provides a noticeable step up in playing performance and is suitable for serious training, high-level clubs and competitive environments.
            </p>
...
export default PyramidPNS760Detail;
