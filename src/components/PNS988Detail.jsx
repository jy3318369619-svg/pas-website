...
const PNS988Detail = () => {
  ...
  const colors = [
    { name: 'Electric Blue', value: '#003366', image: '/images/PNS 988 Electric blue.png' },
    { name: 'Powder Blue', value: '#4682B4', image: '/images/PNS 988 Powder blue.png' },
    { name: 'Yellow Green', value: '#4A8B6F', image: '/images/PNS 988 Yellow Green.png' }
  ];
