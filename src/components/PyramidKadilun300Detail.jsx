...
const PyramidKadilun300Detail = () => {
  const navigate = useNavigate();
  const [selectedColor, setSelectedColor] = useState(0);

  const colors = [
    { name: 'Yellow Green', value: '#4A8B6F', image: '/images/kadilun-300-pyramid.png' }
  ];
  ...
  const specs = [
    ...
    { label: 'Composition', value: '20% Wool\n80% Acrylic' },
    { label: 'Width', value: '1.95m' },
    { label: 'Table Size', value: '3.85m bed cloth + 0.17m cushion cloth × 6' }
  ];

  const keyFeatures = [
    'Basic Model Pyramid cloth',
    'Durable and economical',
    'Good resistance to daily wear',
    'Easy to maintain',
    'Suitable for recreational clubs, training tables and high-frequency commercial use'
  ];
    ...
    <div className="product-detail-page" style={{ minHeight: '100vh', background: '#ffffff', padding: '104px 0 64px 0' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 40px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '80px', alignItems: 'center' }}>
          <img src={colors[selectedColor].image} alt="KADILUN 300 Pyramid" style={{ width: '100%', height: 'auto', objectFit: 'contain' }} />
          ...
          <div>
            ...
            <p style={{ fontSize: '1.1rem', color: '#1d1d1f', lineHeight: 1.6, marginBottom: '32px' }}>
              KADILUN 300 is a Basic Model Pyramid billiard cloth designed for recreational and commercial use where durability and cost efficiency are the main priorities. Its wool-acrylic blend provides good wear resistance and easy maintenance, making it suitable for clubs with high table usage, training tables, and budget-conscious installations.
            </p>
...
export default PyramidKadilun300Detail;
