...
const BaekelandPurplePandaSeriesDetail = () => {
        ...
        <div style={{
          ...
          <div className="product-detail-grid">
            ...
            <img 
              ...
              alt="Baekeland Purple Panda Series"
              style={{
                width: '100%',
                height: 'auto',
                objectFit: 'contain'
            ...
            <div>
              ...
              <p style={{
                ...
                Original Design (Panda Limited Edition)
              </p>
          ...
          <div style={{
            ...
            <div style={{
              marginTop: '32px',
              padding: '32px',
              background: 'linear-gradient(135deg, #f3e5ff 0%, #e0c3ff 100%)',
              borderRadius: '16px',
              textAlign: 'center',
              border: '2px solid #9333ea'
            }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ width: '40px', height: '1px', background: '#9333ea', opacity: 0.6 }} />
              <div style={{ 
                width: '8px', 
                height: '8px', 
                background: '#9333ea', 
            ...
            <div style={{
              ...
              <div style={{
                ...
                <a 
                  ...
                  onMouseEnter={(e) => {
                    e.target.style.color = '#7c2d92';
                    e.target.style.borderBottomColor = '#7c2d92';
                    e.target.style.transform = 'translateY(-1px)';
                  }}
                  onMouseLeave={(e) => {
                    e.target.style.color = '#9333ea';
                    e.target.style.borderBottomColor = '#9333ea';
